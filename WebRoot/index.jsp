  ...
  <div id="header">
    ...
    <ul class="pages">
      ...
      <li><a href="contact.html">Contact Page</a></li>
       ...
       <li> <a href="index.jsp?current=<%="f" %>"> 首页</a></li>
       <li> <a href="index.jsp?current=<%=""+(currentpage+1)%>"> 下一页</a></li>
       <li> <a href="index.jsp?current=<%=""+(currentpage-1)%>"> 上一页</a></li>
    </ul>
    <!-- end pages -->
    <!-- begin categories -->
    <ul class="categories">
...
<div class="uneven post">
      <img src="<%if(in1!=null){out.println(in1.getpicmin()); }%>" />
      <p> <%if(in1!=null)
            {
           ...
           %></p>
      <p class="category"><a href="sorry.jsp">了解TA</a></p>
